...
public class DefaultParcelCountServiceTest {
    private DefaultParcelCountService defaultParcelCountingService = new DefaultParcelCountService();

    @Test
    void count_withInputEmptyList() {
        List<Truck> trucks = new ArrayList<>();
        List<TruckParcelCountDto> result = defaultParcelCountingService.count(trucks);
        assertThat(result).isEmpty();
    }

    @Test
    void count_emptyTruck() {
    ...
    @Test
    void count_oneTruckOneParcelType() {
    ...
    @Test
    void count_oneTruckMultipleParcelTypes() {
        Truck truck = new Truck(3, 3);
